...
require_once(FLOTHEME_PATH . "/functions/twitteroauth/twitteroauth.php");
...
function flo_display_latest_tweets (
    ...
    $consumerkey         = flo_get_option('twi_consumer_key');          //"xxxxxxxxxxxxxxxxxxxxxxxxxxx";
    $consumersecret      = flo_get_option('twi_consumer_secret');       //"xxxxxxxxxxxxxxxxxxxxxxxxxxx";
    $accesstoken         = flo_get_option('twi_access_token');          //"xxxxxxxxxxxxxxxxxxxxxxxxxxx";
    $accesstokensecret   = flo_get_option('twi_access_token_secret');   //"xxxxxxxxxxxxxxxxxxxxxxxxxxx";

    // var_dump($consumerkey, $consumersecret, $accesstoken, $accesstokensecret);
