...
The legacy Laravel/WordPress/React code still lives at the repository root
(`website/`, `admin/`, `blog/`). This `bridalteam-app/` directory is the new,
self-contained version — nothing in it depends on the old stack.
